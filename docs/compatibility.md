...
|---|---|---|---|---|
| OpenAI Codex CLI | 0.156.1 | Native marketplace add + plugin add + list thực sự thành công; enabled rc.1 | Chưa chạy smoke có model | Đã implement adapter chính thức; chưa có live run |
